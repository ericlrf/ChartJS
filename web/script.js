...
function  init() {
//    gerarDados();
//    var largura = document.getElementsByTagName("input");
//    alert(largura);
    function f1 (){if (document.getElementById("grande").checked){
        document.getElementById("canvas").setAttribute("height", 800);
        document.getElementById("canvas").setAttribute("width", 800);
        myLineChart.animateScale
    }}
...
//    var diaMesAno, acumulado, mensal;
    function myTimer() {
//        for (i = 4; i < arrayAcumulado.length; i++) {
        myLineChart.addData([arrayAcumulado[i], arrayMensal[i]], arrayDiaMesAno[i]);
        myLineChart.removeData(i - 4);
        i += 1;
//        }
    }
}
